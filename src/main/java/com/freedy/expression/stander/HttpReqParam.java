...
public final class HttpReqParam implements HttpObject {
    ...
    public void setJsonContent(String content) throws UnsupportedEncodingException {
        JSON.parse(content);
    ...
    public void setTextContent(String content) throws UnsupportedEncodingException {
        setContent(content.getBytes("UTF-8"));
        contentType = "text/plain";
    }

    @CMDParameter(value = "-x", helpText = "xml content")
    public void setXmlContent(String content) throws UnsupportedEncodingException {
        setContent(content.getBytes("UTF-8"));
    ...
    public String toString() {
        return new PlaceholderParser("\n"+"?->\n"+"?? ? HTTP/1.1?\n"+"?*\n"+"\n"+"?\n"+"",
                ...
                uri,
                Color.END,
                headers.stream().map(e -> e.getKey() + ": " + e.getValue()).collect(Collectors.toList()),
