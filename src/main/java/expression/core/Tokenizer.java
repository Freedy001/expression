...
public class Tokenizer {
    ...
    //[<=>| static !+_*?()]
    static final Set<Character> operationSet = new HashSet<>(Arrays.asList('=', '<', '>', '|', '&', '!', '+', '-', '*', '/', '(', ')', '?', '^'));
    static final Set<Character> operationWithOutBracketSet = new HashSet<>(Arrays.asList('=', '<', '>', '|', '&', '!', '+', '-', '*', '/', '?', '^'));
    static final Set<Character> bracket = new HashSet<>(Arrays.asList('(', ')'));
