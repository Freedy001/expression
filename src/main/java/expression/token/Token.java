...
public abstract  class Token implements Comparable
    ...
    private String opsAndAssign(String result, Token type) {
        if (this instanceof Assignable ) {
Assignable assignable = (Assignable) this;
...
Class<?> clazz = (Class<?>) desiredType;
            this.desiredType = clazz;
            return doCalculate(clazz);
        } else if (desiredType instanceof ParameterizedType ) {
ParameterizedType clazz = (ParameterizedType) desiredType;
